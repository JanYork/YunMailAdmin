...
const tabData = ref<App.MessageTab[]>([
  {
    ...
    list: [
      { id: 1, icon: 'ri:message-3-line', title: '邮件投递完成', date: '2022-06-17' },
      { id: 4, icon: 'ri:message-3-line', title: '信件物流信息需要填写', date: '2022-06-17' },
      { id: 2, icon: 'ri:message-3-line', title: '短信通知出现异常', date: '2022-06-16' },
      { id: 3, icon: 'ri:message-3-line', title: '系统发生了莫名错误', date: '2022-06-07' }
    ]
  },
  {
    key: 2,
    ...
    list: [
      {
        ...
        title: '邮件发出通知',
        svgIcon: 'avatar',
        description: '今日邮件均投递完成！',
        date: '2023-04-24 22:45:32'
      }
    ]
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        icon: 'ri:calendar-todo-line',
        title: '信件审核通知',
        description: 'ID: 47466422222 信件需要二次审核',
        date: '2023-04-24',
        tagTitle: '已开始',
        tagProps: { type: 'default' }
      }
